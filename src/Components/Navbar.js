        ...
        <div className='scrollbar-hide '>
            <div className="drawer drawer-end">
                        ...
                        <form onSubmit={handleSearch} className='hidden md:block '>
                            <div className="form-control text-gray-500 ">
                                <div className="input-group">
                                    <input name='name' type="text" placeholder="Search your city" className="input  w-96" />
                        ...
                        <div className="flex-none lg:hidden">
                            <div>
                                <label className="swap swap-rotate">
                                    ...
                                    <input type="checkbox" className='' data-toggle-theme="light,dark" />
                ...
                <div className="drawer-side">
                    ...
                    <ul className="menu p-4 overflow-y-auto w-1/2 bg-base-100">
